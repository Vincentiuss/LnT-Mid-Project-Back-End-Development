            ...
            <div class="card-body">
                <form action="{{url('createKaryawan')}}" method="Post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="Age" type="numeric" class="form-control" id="formGroupExampleInput" placeholder="Input Age" value="{{ old('Age') }}">


                    </div>
                    <div class="mb-3">
                        <label for="Address" class="form-label">Employee Address</label>
                        <input name="Address" type="text" class="form-control" id="formGroupExampleInput" placeholder="Input Address" value="{{ old('Address') }}">
                    </div>
                    <div class="mb-3">
                        <label for="Phone" class="form-label">Phone Number</label>
                        <input name="Phone" type="text" class="form-control" id="formGroupExampleInput" placeholder="Input Phone" value="{{ old('Phone') }}">
                    </div>


                    <a href="{{url('get-books')}}"></a><button type="submit" class="btn btn-success">Insert</button></a>
                    <br>
                    <br>
                </form>
